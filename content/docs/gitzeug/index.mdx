---
title: gitzeug
description: A CLI toolkit for streamlined Git operations.
icon: House
---

## About
Git is a very powerful tool. But sometimes, I don't need powerfull. I need simple, easy, fast.
...
- **AI generated commit messages**: Generate commit messages using AI based on the changes made.
